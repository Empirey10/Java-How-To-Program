// Fig. 7.18: GradeBook4.java
// GradeBook4 class using a two-dimensional array to store grades.
...
public class GradeBook4
{
	...
	// perform varios operations on the data
	public void pricessGrades()
	{
		// output grades array
		outputGrades();
		
		// call methods getMinimum and Maximum
		System.out.printf( "\n%s %d\n%s %d\n\n",
	...
	{
		// assume first element of grades array is samllest
	...
	public int getMaximum()
	{
		...
		return highGrade; // return highhest grade
	...
	public void outputBarChart()
	{
		...
		// for each grade frecuency, print bar in chart
